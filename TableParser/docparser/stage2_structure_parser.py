...
from docparser.utils.structure_utils import create_flat_annotation_list, merge_annotation_lists_util
...
class StructureParser(object):
    ...
    def create_structure_for_doc(self, detection_result_file, table_mode=False, do_postprocessing=False, max_loop_count=30):
    ...
    def create_gui_doc_entry(self, debug_gui_folder, flat_annotations, img_path, out_tag='debugstruct-ws', page=0, total_pages=1):
...
#    if img_path.startswith('../../acl'):
#        img_path = img_path.replace('../../acl/','/mnt/ds3lab-scratch/arxiv/acl/')
#    try:
